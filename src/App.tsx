      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
          {[
            ...
            <span key={skill} style={{ backgroundColor: '#1f2937', padding: '4px 12px', borderRadius: '9999px', fontSize: '0.875rem' }}>
              {skill}
            </span>
          ))}
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
          <div style={{ backgroundColor: '#1f2937', padding: '16px', borderRadius: '12px' }}>
            ...
            <p style={{ color: '#9ca3af', marginTop: '8px' }}>
              Full-cycle pentest including recon, exploitation, and reporting.
            </p>
            <button style={{ marginTop: '16px', backgroundColor: '#2563eb', padding: '8px 16px', borderRadius: '8px', color: '#fff', border: 'none', cursor: 'pointer' }}>
              View Details
            </button>
          </div>
          ...
          <div style={{ backgroundColor: '#1f2937', padding: '16px', borderRadius: '12px' }}>
            ...
            <p style={{ color: '#9ca3af', marginTop: '8px' }}>
              Custom Python-based scanner for identifying web vulnerabilities.
            </p>
            <button style={{ marginTop: '16px', backgroundColor: '#2563eb', padding: '8px 16px', borderRadius: '8px', color: '#fff', border: 'none', cursor: 'pointer' }}>
              View Details
            </button>
